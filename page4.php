...
<html>
    <head>
        <title>Мебель для детской</title>
        <meta charset="utf-8">
...
<div id="right">
    <div bgcolor=#F5DEB3 text=#A0522D>
        <div class="container">
            <h2>Все товары категории "Детская":</h2>
            <table style="text-align:center;">
                <tr>
                    <td>
                        <div style="max-width: 300px;">
                            <img src="images/детская1.jpg " width=300 height=200>
                            <p><b>Детская кровать</b></p>
                        </div>
                    </td>
                    <td>
                        <div style="max-width: 300px;">
                            <img src="images/детская2.jpg " width=300 height=200>
                            <p><b>Детская кровать</b></p>
                        </div>
                    </td>
                    <td>
                        <div style="max-width: 300px;">
                            <img src="images/детская3.jpg " width=300 height=200>
                            <p><b>Детская кровать</b></p>
                        </div>
                    </td>
                </tr>
